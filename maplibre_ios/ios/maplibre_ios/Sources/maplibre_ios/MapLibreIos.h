...
+ (NSPredicate * _Nullable)parsePredicateWithFilter:(NSString * _Nonnull)filter SWIFT_WARN_UNUSED_RESULT;
/// Set the predicate (filter) on a style layer.
+ (void)setLayerPredicateWithLayer:(NSObject * _Nonnull)layer predicate:(NSPredicate * _Nullable)predicate;
