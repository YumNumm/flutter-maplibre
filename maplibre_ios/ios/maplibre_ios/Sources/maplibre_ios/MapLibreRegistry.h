...
+ (NSString * _Nullable)setFilterWithTarget:(NSObject * _Nonnull)target filter:(NSString * _Nonnull)filter SWIFT_WARN_UNUSED_RESULT;
...
+ (double)altitudeForZoomLevelWithZoomLevel:(double)zoomLevel mapView:(MLNMapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
+ (double)zoomLevelForAltitudeWithAltitude:(double)altitude mapView:(MLNMapView * _Nonnull)mapView SWIFT_WARN_UNUSED_RESULT;
